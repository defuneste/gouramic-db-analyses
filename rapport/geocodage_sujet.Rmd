...
Il va être important pour la base de données de clarifier lorsqu'on a bien une seule adresse mais distincte en dates.
...
## Nombre d'adresses par sujet arpès suupression des NA
...
Retirer les valeurs manquantes semble corriger un peu le nombre elevé de sujets avec une adresse (\@ref(fig:histonbadressemaxNA)). Le jeu comprends `r nrow(allsujet_clean.dat)` lignes pour `r length(unique(substr(allsujet_clean.dat$Id_cart, 1,7)))` sujets. Le nombre moyenne d'adresse par sujet passe à 6,78 avec un écart type de 3,37.


(ref:histonbadressemax) Distribution du nombre d'adresses par sujet sans les valeurs manquantes
