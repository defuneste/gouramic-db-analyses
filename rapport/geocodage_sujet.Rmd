...
Il y a `r nrow allsujet_clean.dat[is.na(allsujet_clean.dat$Commune),]` communes d'adresses manquantes sur 46 sujets (un sujet possède 3 adresses manqantes).

Le graphique n \@ref(fig:adressemanquantes) représente la répartition des valeurs manquantes dans le numero d'adresse. On peut constater que la majorité des cas sont pour la première adresse. 
